...
echo "🧪 Testing: ./gh-comment add $PR_NUM src/api.js 42 "[SUGGEST:+2: const timeout = 5000;]""
./gh-comment add $PR_NUM src/api.js 42 "[SUGGEST:+2: const timeout = 5000;]"
if [[ $? -eq 0 ]]; then
...
echo "🧪 Testing: ./gh-comment add $PR_NUM src/api.js 42 "[SUGGEST: const timeout = 5000;]""
./gh-comment add $PR_NUM src/api.js 42 "[SUGGEST: const timeout = 5000;]"
if [[ $? -eq 0 ]]; then
...
echo "🧪 Testing: ./gh-comment add $PR_NUM src/api.js 40 "[SUGGEST:+2: // Add error handling]""
./gh-comment add $PR_NUM src/api.js 40 "[SUGGEST:+2: // Add error handling]"
if [[ $? -eq 0 ]]; then
...
echo "🧪 Testing: ./gh-comment add $PR_NUM src/api.js 45 "[SUGGEST:-1: import { logger } from './utils';]""
./gh-comment add $PR_NUM src/api.js 45 "[SUGGEST:-1: import { logger } from './utils';]"
if [[ $? -eq 0 ]]; then
